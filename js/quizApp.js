var ctrls = {};
ctrls.questionsCtrl = function($scope, $http)
{
  ...
  .config(function($routeProvider)
    {
      $routeProvider
        .when('/',
          { templateUrl : 'views/questions.html', controller : 'questionsCtrl' })
        .when('/results',
          { templateUrl : 'views/results.html', controller : 'questionsCtrl' })
