...
class QuizQuestion {
  ...
  public function __construct()
  {
    ...
    define('TOTAL_POSSIBLE_POINTS', count($this->qItemArray) - 1);
  }



  // return the current quiz object
  public function returnTheQuizItem( $count = 0, $answered )
  {
  ...
  {
    self::$correct = ( $a == $this->qItemArray[$this->quizItemCount - 1]['correct']) ? self::$correct + 1 : self::$correct;
  }
